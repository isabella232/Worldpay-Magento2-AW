...
class CheckoutLabels extends \Magento\Framework\App\Config\Value
{
    ...
    public function __construct(
        ...
        \Sapient\AccessWorldpay\Helper\CheckoutLabels $checkoutLabels,
        ...
        $this->checkoutLabels = $checkoutLabels;
    ...
    {
        $value = $this->getValue();
        $value = $this->checkoutLabels->makeArrayFieldValue($value);
        $this->setValue($value);
    }
    ...
    public function beforeSave()
    {
        ...
        $check = $this->checkoutLabels->makeStorableArrayFieldValue($resultArray);
        $this->setValue($check);
    }
}
