...
define(
    ...
    function (Component, $, quote, customer,validator, url, placeOrderAction, redirectOnSuccessAction,ko, setPaymentInformationAction, errorProcessor, urlBuilder, storage, fullScreenLoader, googlePay) {
        ...
        function getGooglePaymentsClient() {
            if ( paymentsClient === null ) {
                    ...
                    ({environment: window.checkoutConfig.payment.general.environmentMode});
                }
       ...
       //apple pay validation
        ...
        return Component.extend({
            defaults: {
                ...
                template: 'Sapient_AccessWorldpay/payment/wallets',
                cardHolderName:'',
            ...
            initObservable: function () {
                ...
                quote.billingAddress.subscribe(function (newAddress) {
                    if (quote.billingAddress._latestValue != null  &&
                        quote.billingAddress._latestValue.countryId != billingAddressCountryId) {
                        billingAddressCountryId = quote.billingAddress._latestValue.countryId;
            ...
            */
            ...
            preparePayment:function() {
                ...
                if(this.getselectedCCType()== undefined){
                    $('#wallets-error').css({'display' : 'block','margin-bottom': '7px'});
                    $('#wallets-error').html(getWalletsExceptions('CCAM22'));
                    return false;
                }               

                if (this.getselectedCCType()=='APPLEPAY-SSL') {
                    console.log('got it from applessl'); 
                    //---------------------------------- Apple Pay starts -----------------------
                    ...
                    session.onpaymentauthorized = function (event) {
                        ...
                        console.log('appleResponse before stingfy');
                        console.log(event.payment.token)
                        appleResponse = JSON.stringify(event.payment.token);
                        console.log('appleResponse after stingfy');
    ...
    function getWalletsExceptions (exceptioncode){
